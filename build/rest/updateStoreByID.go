...
func UpdateStoreByID(c echo.Context) error {
	...
	log.Info().Str("traceId", traceId).Str("spanId", spanId).Str("path", "/").Msg("UpdateStoreByID")
	...
	// implement your functionality best using a function from a separate file, e.g. usecases/UpdateStoreByIDDo.go
